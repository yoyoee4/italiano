/* ═══════════════════════════════════════════════
   VolaLingo — Coach Module (Nona)
   Extracted from nona.js — Zero behavior change
   ═══════════════════════════════════════════════ */
...
// ═══════════════════════════════════════
// MESSAGES (copied verbatim from nona.js)
// ═══════════════════════════════════════
...
const COACH_ENCOURAGE_MISTAKES = [
...
function coachEncourageMistake() { return pick(COACH_ENCOURAGE_MISTAKES); }
...
function onVisit() {
  ...
  if (window.state && state.streak > 2) {
    setTimeout(() => {
...
function startNagTimer() {
  ...
  if (window.state && state.streak > 0) {
...
function init() {
  ...
  console.log('🧓 Coach (Nona) ready!');
}

// ═══════════════════════════════════════
// EXPOSE (Nona-compatible API)
// ═══════════════════════════════════════
return {
...
// Backward compatibility: window.Nona = window.Coach
window.Nona = Coach;
